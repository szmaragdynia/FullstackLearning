...
const url = `mongodb+srv://fullstack:${password}@cluster0.p4fqzx6.mongodb.net/testNoteApp?retryWrites=true&w=majority`
...
Note.find(searchQuery).then(result => { //!!!!!!!!!!!!!! "Note" not "note". find is working on model
    console.log('getting all notes (probably without latest):')
    result.forEach(note => {
        console.log(note)
    })
